 ...
 * 虚拟广场信息流 —— 只属于 `/square`。
 *
 * 2026-09-15 两条主线重构：这条流原先首页与 /square 各铺一份，同一份内容出现在
 * 两个 Tab 里；而且它展示的是「哪些分身答过什么」，属于「分身发现」那条主线，
 * 长在提问页上正是「两条主线混在一起」的来源。现在整条流只留在 `/square`，
 * 首页只引用下面的 `DISCUSSION_TOPICS` 做「不知道问什么」的快填。
 *
