// x-zse-96 v3 签名实现（转译自 RSSHub lib/routes/zhihu/execlib/x-zse-96-v3.ts，MIT）
// 原始实现署名：https://blog.csdn.net/zjq592767809/article/details/126512798
// 仅供本地离线抓取使用；生成的语料与脚本不入公开仓库。
/* eslint-disable */
...
export function encrypt(md5Str) {
